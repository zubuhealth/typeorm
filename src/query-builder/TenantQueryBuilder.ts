...
import { MissingTenantColumnError } from "../error/MissingTenantColumnError"

/**
 * Allows to build complex sql queries in a fashion way and execute those queries.
 */
export class TenantQueryBuilder<Entity extends ObjectLiteral>
    extends QueryBuilder<Entity>
    implements WhereExpressionBuilder
{
    readonly "@instanceof" = Symbol.for("TenantQueryBuilder")
    ...
    from<T extends ObjectLiteral>(
        ...
        return this as any as TenantQueryBuilder<T>
    }
    ...
    protected createUpdateExpression() {
        ...
        if (!metadata.tenantColumn) {
            throw new MissingTenantColumnError(metadata)
        }
        ...
        if (metadata.tenantColumn && this.connection.options.tenant) {
            updateColumnAndValues.push(
                this.escape(metadata.tenantColumn.databaseName) +
                    " = " +
                    this.escape(this.connection.options.tenant),
            )
        }
